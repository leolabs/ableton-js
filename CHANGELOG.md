...
#### [v5.0.3](https://github.com/leolabs/ableton.js/compare/v5.0.2...v5.0.3)

- :loud_sound: Add more logging around latency issues [`f7b245e`](https://github.com/leolabs/ableton.js/commit/f7b245e5360cd2d985b36922c08b015b9c332558)

#### [v5.0.2](https://github.com/leolabs/ableton.js/compare/v5.0.1...v5.0.2)

> 19 September 2026

- :sparkles: Send event updates with a higher priority than command results [`8d8ba6a`](https://github.com/leolabs/ableton.js/commit/8d8ba6ab0ae876a44e653184b961825e03a59544)

#### [v5.0.1](https://github.com/leolabs/ableton.js/compare/v5.0.0...v5.0.1)

> 15 September 2026

- :sparkles: Improve the error message when adding a listener fails [`2a88d16`](https://github.com/leolabs/ableton.js/commit/2a88d16c56014703852304df999bb016ae6a33f7)
- :loud_sound: Log payload UUID and command details when an exception is caught [`68f6501`](https://github.com/leolabs/ableton.js/commit/68f6501d4dddfcb91513085d65003f859c90f7cf)

### [v5.0.0](https://github.com/leolabs/ableton.js/compare/v5.0.0-4...v5.0.0)

> 11 September 2026

- Ableton.js 5.0, the WebSocket Release [`#142`](https://github.com/leolabs/ableton.js/pull/142)
- :rotating_light: Fix all auto-fixable Biome warnings [`4520c66`](https://github.com/leolabs/ableton.js/commit/4520c66fa4ef0281829242aec5bc0778fcbc1157)
- :white_check_mark: Add connection tests using a fake WebSocket [`23f9a6b`](https://github.com/leolabs/ableton.js/commit/23f9a6b379d99498c40dc3af98cd8a4645a062cd)
- :package: Add Biome for linting [`68de133`](https://github.com/leolabs/ableton.js/commit/68de1335b6d61caa0b4cf9e8de80ec3f2cde5f65)
- :wrench: Exclude test helpers from the NPM package [`3920448`](https://github.com/leolabs/ableton.js/commit/392044818f0e40510c1283d29c814a0d5ab44602)
- :label: Improve typing of nullable properties [`38e774c`](https://github.com/leolabs/ableton.js/commit/38e774cc7e333c791ad97eac6898c9826951d67b)
- :bug: Fix disconnect event not firing correctly on heartbeat timeouts [`cff0bbb`](https://github.com/leolabs/ableton.js/commit/cff0bbbfff56416a5ca1183ca26dbc78f7153efc)
- :bug: Fix `waitForConnection` potentially waiting forever when the connection was closed instantly [`05fb2f1`](https://github.com/leolabs/ableton.js/commit/05fb2f18b27021bc56324a1bfa91760ab5f11420)
- :sparkles: Add more information to serialized Python errors [`62f4b07`](https://github.com/leolabs/ableton.js/commit/62f4b07c636723bfa42d67d96bf8a44292342ce5)
- :rotating_light: Fix all remaining Biome warnings [`a2b445c`](https://github.com/leolabs/ableton.js/commit/a2b445cfad135dc633b97cb68c00635288bd3b1d)
- :bug: Fix heartbeat ping not being sent when a command takes too long to process, so the connection isn't marked as disconnected [`8784c8a`](https://github.com/leolabs/ableton.js/commit/8784c8a8cf488613a8867b395924995603138a5d)
- :wrench: Set up a TCP timeout of 3 seconds by default [`0176dbb`](https://github.com/leolabs/ableton.js/commit/0176dbb959e266ab38d5f3040a57ef3b6accee36)
- :bug: Fix errors being thrown as strings [`31e5923`](https://github.com/leolabs/ableton.js/commit/31e59237d5a2fe5b4e8c7a73990252e38fa4868d)
- :sparkles: Properly transform the appointed device into a Device object [`66c79b6`](https://github.com/leolabs/ableton.js/commit/66c79b6fb593a7abe9bcaa00e8d6a98b6502c2bb)
- :bug: Scope the 200-packet limiter to the Ableton class instead of a global variable that is shared by all Ableton class instances [`6b521ab`](https://github.com/leolabs/ableton.js/commit/6b521abdcf1af89c338c3525cefdf2c884f86d0d)

#### [v5.0.0-4](https://github.com/leolabs/ableton.js/compare/v5.0.0-3...v5.0.0-4)

> 27 August 2026

- :bento: Generate new ableton.js file for static use [`331313c`](https://github.com/leolabs/ableton.js/commit/331313cb6ffafac73a7d59559cbc4195e370ac0e)
- :sparkles: Expand support of Chains [`dc43dc0`](https://github.com/leolabs/ableton.js/commit/dc43dc0e11b28e20e01cd7742bc3a14959085404)
- :bento: Update compiled ableton.js bundle in the static folder [`d7c335a`](https://github.com/leolabs/ableton.js/commit/d7c335ac0cfab67f8b016cfbd9cffa0cbe808f14)

#### [v5.0.0-3](https://github.com/leolabs/ableton.js/compare/v5.0.0-2...v5.0.0-3)

> 25 August 2026

- :sparkles: Add static file serving and include a basic web page that allows users to interact with Ableton.js in the browser console [`fe44d7b`](https://github.com/leolabs/ableton.js/commit/fe44d7b46c7ec57188cb557d9ba14d1db14a2b70)
- :sparkles: Add introspection features to retrieve available functions and properties from Live's API [`1077efe`](https://github.com/leolabs/ableton.js/commit/1077efe7334615e554efbe4ff2418603ce83b1c9)
- :sparkles: Add caching tests [`710eee6`](https://github.com/leolabs/ableton.js/commit/710eee6ae7808c94f792867876a8579f7bf1d8df)

#### [v5.0.0-2](https://github.com/leolabs/ableton.js/compare/v5.0.0-1...v5.0.0-2)

> 24 August 2026

- :sparkles: Add support for DeviceView and LooperDevice [`8d8b4b0`](https://github.com/leolabs/ableton.js/commit/8d8b4b02c583eecfe2547aca91160418c7c1a059)
- :sparkles: Update namespaces to conform to Live 12.4's API [`9bdd356`](https://github.com/leolabs/ableton.js/commit/9bdd356435eb44180108b529f5b20263bb7e4836)
- :fire: Remove support for Live 10, add an unsupported message when loading the plugin in Live 10 or earlier [`fa7b57a`](https://github.com/leolabs/ableton.js/commit/fa7b57a53843015e2d2eec4182babe6069037b09)

#### [v5.0.0-1](https://github.com/leolabs/ableton.js/compare/v5.0.0-0...v5.0.0-1)

> 21 August 2026

- :sparkles: Combine multiple commands into one TCP packet [`0aeb9c6`](https://github.com/leolabs/ableton.js/commit/0aeb9c621ad0e17d1b24bc9ee1575fc856d19987)
- :memo: Add docs to public functions [`5818f22`](https://github.com/leolabs/ableton.js/commit/5818f22a4f0fd9175b251f0cde72ecf2f7baef91)
- :bug: Fix failed WebSocket handshakes potentially hanging forever [`d21ffcf`](https://github.com/leolabs/ableton.js/commit/d21ffcfb8307c9fe467bea2ed2203f56a998f7f4)

#### [v5.0.0-0](https://github.com/leolabs/ableton.js/compare/v4.1.0...v5.0.0-0)

> 20 August 2026

- fix: register missing Chain/DrumPad namespace [`#139`](https://github.com/leolabs/ableton.js/pull/139)
- fix: get_notes_extended fails on arrangement clips (int vs double) [`#140`](https://github.com/leolabs/ableton.js/pull/140)
- fix: CuePoint.SettableProperties missing name [`#141`](https://github.com/leolabs/ableton.js/pull/141)
- :construction: Implement basic WebSocket support [`6d205bf`](https://github.com/leolabs/ableton.js/commit/6d205bf9ab5f8a819656668deaf23879aeb73cc7)
- :building_construction: Extract WebSocket-related code into a separate file [`ce081c7`](https://github.com/leolabs/ableton.js/commit/ce081c74c0a4a565f888c695688a39b11db4aa32)
- :white_check_mark: Add tests around the handling of listeners [`51c7703`](https://github.com/leolabs/ableton.js/commit/51c77030c67e5363784c30e08e8d165cf4e49efd)
- :zap: Send value updates only to clients that have requested them [`5c27e3d`](https://github.com/leolabs/ableton.js/commit/5c27e3def9e0b82cab3992eb84d437e8408d2a08)
- :sparkles: Add a new `PASSWORD` config field to require authentication [`71c87d8`](https://github.com/leolabs/ableton.js/commit/71c87d8712038d3ba1eff9d4fde509528c11e066)
- :sparkles: Send responses on a separate thread as well [`f8bc878`](https://github.com/leolabs/ableton.js/commit/f8bc87892dc2093fbfc3de3f0115a86703c1045f)
- :sparkles: Extract listener handling into a new `ConnectionSubscribers` class, make Midi use the same class for less duplicated code [`00ac71b`](https://github.com/leolabs/ableton.js/commit/00ac71b049932338f142fe51a615b619e26215b3)
- :art: Consolidate handleUncompressedMessage and handleIncoming into one function [`4ca87d1`](https://github.com/leolabs/ableton.js/commit/4ca87d1b18a8415ef97fdc13fac506b5aac9a8cc)
- :art: Split sending functions into `send_to` and `broadcast` to more easily discern what they do as opposed to the optional connection argument [`3975c20`](https://github.com/leolabs/ableton.js/commit/3975c2050b5e982d10eae74276182acb0118e82b)
- :lock: Don't send the password in plaintext, but send a hash of the password with a per-connection salt instead [`eb1df94`](https://github.com/leolabs/ableton.js/commit/eb1df944b4fc918d336682fe4ddd2bf59effa993)
- :sparkles: Improve client-side connection lifecycle and error handling [`9ab2a87`](https://github.com/leolabs/ableton.js/commit/9ab2a871b80a10cd05316a301acd7c0ea4953e68)
- :bug: Fix processing loop exiting for all commands after an object ID was not found [`f6cde35`](https://github.com/leolabs/ableton.js/commit/f6cde35d35ef1f929658529e87687be8e71ff6bd)
- :zap: Send small frames directly instead of enqueueing them first to reduce latency [`3da707c`](https://github.com/leolabs/ableton.js/commit/3da707ce9fca03a6dd00a665a2f3a667a1f577a5)
- :zap: Speed up masking incoming WebSocket frames from the client [`c80e16f`](https://github.com/leolabs/ableton.js/commit/c80e16fec13a879a38c91624045a790d74d0db88)
- :package: Update Node types to 20.19.43 [`c98ec03`](https://github.com/leolabs/ableton.js/commit/c98ec03a1a4473f2d4ba3858241155e228c79a14)
- :bug: Fix connection staying open when the start() timeout is reached [`bf435dd`](https://github.com/leolabs/ableton.js/commit/bf435ddfaed94b620a93ba529c44707a2f4f91ac)
- :wrench: Increase default timeout to 3s, and warning to 2s [`e4c110a`](https://github.com/leolabs/ableton.js/commit/e4c110a645b496d0fef50bcefa8ea97f54f5dfab)
- :zap: Don't send heartbeats while other commands are still in-flight [`6555bae`](https://github.com/leolabs/ableton.js/commit/6555bae418388d483c4d18ce0e1fbdf17c517a8f)
- :white_check_mark: Fix incorrect test descriptions for Application View and Browser [`aedb115`](https://github.com/leolabs/ableton.js/commit/aedb115b43444bb9d0c3ddad76e3a6fa6fb02a9a)
- :wrench: Fix missing "node" type configuration [`e79d56c`](https://github.com/leolabs/ableton.js/commit/e79d56c6fda58681ddaf209e8a85abb8408f3f94)
- :package: Revert to 4.1.0 for now [`87458ed`](https://github.com/leolabs/ableton.js/commit/87458ed347e5c8856fd31dfba9acd488bfa4523f)
- :memo: Update AbleSet banner image and link [`cfcb176`](https://github.com/leolabs/ableton.js/commit/cfcb176a658956c7e982ab05ec718b31619654bd)
- :speech_balloon: Improve log warning when the UDP tick is lagging [`9b42291`](https://github.com/leolabs/ableton.js/commit/9b422912f68337bd29ac8c6548dd27e0d41ab99b)

#### [v4.1.0](https://github.com/leolabs/ableton.js/compare/v4.0.4...v4.1.0)

> 10 April 2026

- feat: add Track.createMidiClip() for creating MIDI clips in Arrangement View [`#138`](https://github.com/leolabs/ableton.js/pull/138)
